...
const Hero = ({
  listUser = [
    ...
    },
    {
      name: "Locations",
      number: "20",
      icon: "/assets/Icon/buildings.png",
    },
    {
      name: "Server",
      number: "50",
      icon: "/assets/Icon/servers.png",
    },
  ],
}) => {
...
for the internet in <strong>Iraq</strong>.
              </h1>
              <p className="text-black-500 mt-4 mb-6">
                Provide businesses and entrepreneurs with a full stack payment solutions to accept any payment method available in Iraq
              </p>
              
              <ButtonPrimary><Link href="/payments">Start with Payment</Link></ButtonPrimary>
