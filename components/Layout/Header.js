      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          <div className="col-start-1 col-end-2 flex items-center cursor-pointer">
           <Link href="/"><Logoepay className="h-8 w-auto" /></Link> 
          </div>
          <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500 items-center">
            <LinkScroll
              ...
              className={
                "px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative hover:bg-blue-500 hover:text-white-500 hover:rounded-md" +
                (activeLink === "about"
